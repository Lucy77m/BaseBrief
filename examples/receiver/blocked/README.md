...
The receiver should report the blocking reason without attempting a workaround such as reading sensitive files, executing raw shell commands, or changing the target repository.
